package uz.azamat.liquidswipedemo.liquid_swipe.animation

import android.graphics.Canvas
import android.view.MotionEvent
import uz.azamat.liquidswipedemo.liquid_swipe.animation.Direction.LEFT
import uz.azamat.liquidswipedemo.liquid_swipe.animation.Direction.RIGHT
import uz.azamat.liquidswipedemo.liquid_swipe.EdgeController
import uz.azamat.liquidswipedemo.liquid_swipe.ViewI
...
class LeftEdgeController(
    ...
    override fun drawEdge(canvas: Canvas?) {
        ...
        if (shouldDraw) {
            ...
            canvas?.drawBitmap(
                bitmap!!,
                view.getCurrentItem() * width.toFloat(),
                0f,
                sourceOutPaint
            )
        }
